...
### Self Check
- Does each element have a unique class name? ok
- Did you use the grouping selector for styles that both elements share? ok
- Did you make separate rules for the styles unique to each element? ok
